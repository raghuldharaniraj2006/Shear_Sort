...
module shear_sort_pip_fsm(clk,rst,start,in_1,in_2,in_3,in_4,in_5,in_6,in_7,in_8,in_9,in_10,in_11,in_12,in_13,in_14,in_15,in_16,
...
row_sort r0 (in_mat[0],in_mat[1],in_mat[2],in_mat[3],rw[0],rw[1],rw[2],rw[3]);
row_sort r1 (in_mat[4],in_mat[5],in_mat[6],in_mat[7],rw[7],rw[6],rw[5],rw[4]);
row_sort r2 (in_mat[8],in_mat[9],in_mat[10],in_mat[11],rw[8],rw[9],rw[10],rw[11]);
row_sort r3 (in_mat[12],in_mat[13],in_mat[14],in_mat[15],rw[15],rw[14],rw[13],rw[12]);

column_sort c0 (rw[0],  rw[4],  rw[8],  rw[12],
                cl[0],  cl[4],  cl[8],  cl[12]);

column_sort c1 (rw[1],  rw[5],  rw[9],  rw[13],
                cl[1],  cl[5],  cl[9],  cl[13]);

column_sort c2 (rw[2],  rw[6],  rw[10], rw[14],
                cl[2],  cl[6],  cl[10], cl[14]);
column_sort c3 (rw[3],  rw[7],  rw[11], rw[15],
